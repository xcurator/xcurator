...
public class MappingGeneratorStepTestDBLP extends TestCase {
    ...
    public void testLoadMapping() throws ParserConfigurationException, SAXException, IOException, XPathExpressionException {
        ...
        final String typePrefix = "http://dblp.l3s.de/d2r/directory/";

        final String inputDataPath = "/dblp/data/dblp-sample.xml";
        ...
        for (int m : max) {
            ...
            PrintStream nout = new PrintStream("out-dblp.tmp");
            ...
            serializer = new XMLSerializer(
                    new FileOutputStream("output/dblp/output.dblp.1." + m + ".xml"), format);
            serializer.asDOMSerializer();
            ...
            serializer = new XMLSerializer(
                    new FileOutputStream("output/dblp/output.dblp.2." + m + ".xml"), format);
            serializer.asDOMSerializer();
            serializer.serialize(doc);
            ...
            serializer = new XMLSerializer(
                    new FileOutputStream("output/dblp/output.dblp.3." + m + ".xml"), format);
            serializer.asDOMSerializer();
            serializer.serialize(doc);
            ...
            serializer = new XMLSerializer(
                    new FileOutputStream("output/dblp/output.dblp.4." + m + ".xml"), format);
            serializer.asDOMSerializer();
            serializer.serialize(doc);
            ...
            serializer = new XMLSerializer(
                    new FileOutputStream("output/dblp/output.dblp.5." + m + ".xml"), format);
            serializer.asDOMSerializer();
            serializer.serialize(doc);

...
public class MappingGeneratorStepTestDrugBank extends TestCase {
    ...
    public void testLoadMapping() throws ParserConfigurationException, SAXException, IOException, XPathExpressionException {
        ...
        final String typePrefix = "http://www.drugbank.ca#";

        final String inputDataPath = "/drugbank/data/drugbank.xml";
        ...
        for (int m : max) {
            ...
            PrintStream nout = new PrintStream("out-drugbank.tmp");
            ...
            serializer = new XMLSerializer(
                    new FileOutputStream("output/drugbank/output.drugbank.1." + m + ".xml"), format);
            serializer.asDOMSerializer();
            ...
            serializer = new XMLSerializer(
                    new FileOutputStream("output/drugbank/output.drugbank.2." + m + ".xml"), format);
            serializer.asDOMSerializer();
            serializer.serialize(doc);
            ...
            serializer = new XMLSerializer(
                    new FileOutputStream("output/drugbank/output.drugbank.3." + m + ".xml"), format);
            serializer.asDOMSerializer();
            serializer.serialize(doc);
            ...
            serializer = new XMLSerializer(
                    new FileOutputStream("output/drugbank/output.drugbank.4." + m + ".xml"), format);
            serializer.asDOMSerializer();
            serializer.serialize(doc);
            ...
            serializer = new XMLSerializer(
                    new FileOutputStream("output/drugbank/output.drugbank.5." + m + ".xml"), format);
            serializer.asDOMSerializer();
            serializer.serialize(doc);

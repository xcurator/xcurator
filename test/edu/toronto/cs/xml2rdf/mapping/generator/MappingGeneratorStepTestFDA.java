...
public class MappingGeneratorStepTestFDA extends TestCase {

    public void testLoadMapping() throws ParserConfigurationException, SAXException, IOException, XPathExpressionException {

        LogUtils.shutup();

        int[] max = new int[]{5}; // 10, 25, 50, 100, 250, 500, 1000 }; //20, 40, 50, 100, 125, 250, 500, 1000, 2000 }; // 5, 10, 20, 40, 50, 100, 125, 250, 500, 1000, 2000};

        final String typePrefix = "http://www.fda.gov#";

         final String inputDataPath = "/fda/tiny.xml";

        final String outputDataFileTemplate = "output/fda/output.fda";
        for (int m : max) {
            ...
            PrintStream nout = new PrintStream("out-fda-tiny.tmp");
